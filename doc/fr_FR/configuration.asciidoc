...
Pour obtenir la clef API direction cette page : https://www.jeedom.com/doc/documentation/plugins/flowerPower/fr_FR/flowerPower

Le plugin est installable sur Jeedom maître et esclave.
